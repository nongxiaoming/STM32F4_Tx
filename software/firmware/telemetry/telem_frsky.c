...
int32_t _frsky_value(struct Telemetry *_t, int idx)
{
...
const char * _frsky_str_by_value(char *str, uint8_t telem, int32_t value)
{
    switch(telem) {
        case TELEM_FRSKY_VOLT1:
        case TELEM_FRSKY_VOLT2:
...
const char * _frsky_name(char *str, uint8_t telem)
{
    switch (telem) {
      case TELEM_FRSKY_VOLT1:
      case TELEM_FRSKY_VOLT2:
...
const char * _frsky_short_name(char *str, uint8_t telem)
{
    switch(telem) {
...
int32_t _frsky_get_max_value(uint8_t telem)
{
    switch(telem) {
        case TELEM_FRSKY_VOLT1:
        case TELEM_FRSKY_VOLT2:
