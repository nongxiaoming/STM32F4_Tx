...
int32_t _devo_value(struct Telemetry *_t, int idx)
{
...
const char * _devo_str_by_value(char *str, uint8_t telem, int32_t value)
{
    switch(telem) {
        case TELEM_DEVO_VOLT1:
        case TELEM_DEVO_VOLT2:
...
const char * _devo_name(char *str, uint8_t telem)
{
    switch (telem) {
      case TELEM_DEVO_VOLT1:
      case TELEM_DEVO_VOLT2:
...
const char * _devo_short_name(char *str, uint8_t telem)
{
    switch(telem) {
...
int32_t _devo_get_max_value(uint8_t telem)
{
    switch(telem) {
        case TELEM_DEVO_VOLT1:
        case TELEM_DEVO_VOLT2:
