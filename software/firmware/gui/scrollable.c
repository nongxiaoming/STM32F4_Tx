...
#if HAS_TOUCH
    static int scroll_cb(guiObject_t *parent, uint8_t pos, s8 direction, void *data);
#else
...
#if HAS_TOUCH
int scroll_cb(guiObject_t *parent, uint8_t pos, s8 direction, void *data) {
    (void)parent;
    (void)pos;
