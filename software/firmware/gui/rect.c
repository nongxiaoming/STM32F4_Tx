...
guiObject_t *GUI_CreateRect(guiRect_t *rect, uint16_t x, uint16_t y, uint16_t width, uint16_t height, const struct LabelDesc *desc)
{
...
guiObject_t *GUI_CreateRectCB(guiRect_t *rect, uint16_t x, uint16_t y, uint16_t width, uint16_t height, const struct LabelDesc *desc, void (*Callback)(guiObject_t *, const void *), const void *data)
{
